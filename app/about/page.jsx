      ...
      <main className="flex-1 max-w-5xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <h1 className="text-3xl sm:text-5xl font-black text-white tracking-tight">
            About MADANI E-Commerce
          </h1>
          <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
            MADANI is an online marketplace dedicated to bringing you premium quality products across fashion, electronics, home decor, and lifestyle. Built with speed, security, and customer delight at its core.
          </p>
        </div>
        ...
        {/* Contact info card */}
        <div className="bg-slate-900/90 border border-slate-800 rounded-3xl p-8 grid grid-cols-1 md:grid-cols-2 gap-8 items-center shadow-2xl">
          ...
          <div className="bg-slate-950 p-6 rounded-2xl border border-slate-800 space-y-3">
            ...
            <button
              ...
              className="w-full py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-slate-950 font-bold text-xs shadow-md transition-all"
            >
              Submit Message
            </button>
          </div>
