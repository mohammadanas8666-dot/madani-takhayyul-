      ...
      <main className="flex-1 max-w-5xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
            KAZRI is a premium Islamic wear store — Pagdi/Amama, Jubba/Aba, Kurta/Thobe, Rumal, Topi and more, crafted for quality and elegance. Built with speed, security, and customer delight at its core.
          </p>
        </div>
